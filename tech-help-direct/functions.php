...
function thd_enqueue_scripts() {

    wp_enqueue_style( 'theme', get_stylesheet_directory_uri() . '/css/style.css', false, null, 'all' );
}
add_action( 'wp_enqueue_scripts', 'thd_enqueue_scripts', 11 ); 
