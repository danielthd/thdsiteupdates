...
<head>
	...
	})(window,document,'script','dataLayer','GTM-TPZW8WN');</script>
	...
	<!-- Global site tag (gtag.js) - Google AdWords: 953392549 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-953392549"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-953392549');
</script>
<script>
  gtag('config', 'AW-953392549/VJtjCNCb0oIBEKW7zsYD', {
    'phone_conversion_number': '1300 622 843'
  });
</script>
</head>
...
<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TPZW8WN"
